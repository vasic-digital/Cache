#!/usr/bin/env bash
# cache_compile_challenge.sh - Validates Cache module compilation and code quality
set -euo pipefail
...
echo "Test: Module name is digital.vasic.cache"
if grep -q "^module digital.vasic.cache$" "${MODULE_DIR}/go.mod"; then
    pass "Module name is digital.vasic.cache"
else
