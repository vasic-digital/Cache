# Cache - A standalone, generic Go cache module providing core interfaces, multiple backends, distributed patterns, and configurable policies.
# Module: digital.vasic.cache
...
challenge:
	../challenges/scripts/cache_challenge.sh 2>/dev/null || echo "No challenge script"

help:
	@echo "Cache - A standalone, generic Go cache module providing core interfaces, multiple backends, distributed patterns, and configurable policies."
	@echo ""
	@echo "Build & Test:"
